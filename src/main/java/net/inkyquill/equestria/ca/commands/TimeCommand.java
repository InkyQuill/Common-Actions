...
public class TimeCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        if (strings == null || strings.length == 0) {
            ...
            CASettings.plugin.SetWorldsRules();
            new TimeUpdater().runTaskLater(CASettings.plugin, 5);
            ...
            if (strings[1].toLowerCase().equals("status")) {
                if (strings[0].toLowerCase().equals("current")) //we are asking for a status of this world.
                {
                    ...
                    if (w == null)
                        commandSender.sendMessage(PIntro + ChatColor.WHITE + "Sorry, but I don't know the world you asked for. Please check the name.");
                    else {
