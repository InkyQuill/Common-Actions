...
public class CelestialCommand implements CommandExecutor {
    ...
    static{ PIntro = ChatColor.GOLD + "[CA/Celestial] ";}
    ...
    private void handleSet(CommandSender sender, World world, String opt, String val) {
        ...
        else if(opt.equals("ticks"))
        {
            try {
                ...
                sender.sendMessage(PIntro + ChatColor.WHITE + "Ticks of " + ChatColor.GREEN + world.getName() + ChatColor.WHITE + " set to " + ChatColor.BLUE + ts.TicksPerCalc);
            }
            catch(Exception e){
    ...
    private void handleStatus(CommandSender sender, World world) {
        ...
        if(ts.Type== TimeType.real)
        {
            ...
            sender.sendMessage( ChatColor.WHITE +"ticks (Update period): " + ts.TicksPerCalc);
        }
